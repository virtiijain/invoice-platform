          ...
          {filtered.map(client => (
            <div key={client.id} className="client-card" style={{
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: 16 }}>
                ...
                {/* Info */}
                <div>
                  <p style={{ color: colors.textPrimary, fontSize: 15, fontWeight: 600, margin: '0 0 4px', fontFamily: fonts.body }}>{client.name}</p>
                  <div style={{ display: 'flex', gap: 16, flexWrap: 'wrap' }}>
                    <span style={{ display: 'flex', alignItems: 'center', gap: 5, color: colors.textMuted, fontSize: 13, fontFamily: fonts.body }}>
                    ...
                    {client.gst_number && (
                      <span style={{ display: 'flex', alignItems: 'center', gap: 5, color: colors.textMuted, fontSize: 13, fontFamily: fonts.body }}>
                        <Building size={12} /> {client.gst_number}
                      </span>
                    )}
                  </div>
                </div>
