...
export default function LoginPage() {
  ...
  return (
    <div
      style={{ fontFamily: fonts.body, minHeight: "100vh", display: "flex" }}
    >
      <style>{`
      ...
      >
        <div
          style={{
            ...
            height: 280,
            borderRadius: "50%",
            background: `radial-gradient(circle, ${colors.primarySubtle} 0%, transparent 70%)`,
        ...
        <div style={{ position: "relative", zIndex: 10 }}>
          ...
          >
            ...
            <span
              style={{
                ...
                backgroundImage: gradients.primaryText,
                backgroundClip: "text",
              }}
            >
              get paid faster.
          ...
          >
            Professional invoices, client management, and payment tracking — all
            in one place.
          </p>
        </div>
